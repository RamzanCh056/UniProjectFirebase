...
class BookCar extends StatefulWidget {
  BookCar(this.cars, this.curentIndex, {Key? key}) : super(key: key);
...
class _BookCarState extends State<BookCar> {
  ...
  uploadLecture() async {
    ...
    BookRoomModel dataModel = BookRoomModel(
      picture: widget.cars[widget.curentIndex].picture.toString(),
      name: name.text,
      email: email.text,
      paidPrice: widget.cars[widget.curentIndex].price.toString(),
      doc: id.toString(),
    );
    try {
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Image.network(
                    widget.cars[widget.curentIndex].picture.toString(),
                    fit: BoxFit.cover,
                  ),
                ),
                SizedBox(
                ...
                GestureDetector(
                  ...
                  child: CommonTextFieldWithTitle('You Paid for this', '${widget.cars[widget.curentIndex].price}', pay,
                      enabled: false,
                          (val) {
