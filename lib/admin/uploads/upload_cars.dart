...
import 'package:uni_project/models/book_car_model.dart';
...
class _UploadCarsState extends State<UploadCars> {
  ...
  uploadLecture() async {
    ...
    AddCarModel dataModel = AddCarModel(
    ...
    try {
      await FirebaseFirestore.instance.collection("cars").doc('$id').set(dataModel.toJson());
      isLoading = false;
      setState(() {});
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                CommonTextFieldWithTitle('car name', 'Enter name of car', name, (val) {
                  if (val!.isEmpty) {
                    return 'This is required field';
                  }
                }),
          ...
          content: Container(
            ...
            child: Column(
              children: [
                ...
                Container(
                  child: const Text(
                    "car Added Click on close and add another car",
