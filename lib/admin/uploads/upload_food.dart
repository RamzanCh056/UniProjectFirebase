...
class _UploadFoodState extends State<UploadFood> {
  ...
  uploadLecture() async {
    ...
    AddFoodModel dataModel = AddFoodModel(
    ...
    try {
      await FirebaseFirestore.instance.collection("food").doc('$id').set(dataModel.toJson());
      isLoading = false;
      setState(() {});
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                CommonTextFieldWithTitle('price', 'Enter Price of food', price, (val) {
                  if (val!.isEmpty) {
                ...
                CommonTextFieldWithTitle('food name', 'Enter food name', squre, (val) {
                  if (val!.isEmpty) {
                    return 'This is required field';
                  }
                }),
          ...
          content: Container(
            ...
            child: Column(
              children: [
                ...
                Container(
                  child: const Text(
                    "food Added Click on close and add another food",
